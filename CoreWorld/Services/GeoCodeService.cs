...
namespace CoreWorld.Services
{
    ...
    {
        private ILogger<GeoCodesService> _logger;
        private IConfigurationRoot _config;

        public GeoCodesService(ILogger<GeoCodesService> logger,
        ...
        public async Task<GeoCodeResult> GetCoordsAsync(string name)
        {
